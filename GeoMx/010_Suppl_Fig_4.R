# ## Script for Supplementary Figure 4 - DEGs within stroma heatmap
# R version 4.4.0
...
load("./analysis_files/Suppl_Fig_4_Heatmap.RData")

#### Supplementary Figure 4 ####
# Plot the DEGs heatmap comparing stroma clusters
Heatmap(zscores[DEGs,],
        name = "Z-Score",
        border = TRUE,
        column_labels = pData(Chord_stro)$ROI_ID,
