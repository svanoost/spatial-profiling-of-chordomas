## Script for Figure 1C + 1D - Stroma clusters and DEGs
# R version 4.4.0
...
load("./analysis_files/Fig_1C_UMAPs.RData")
load("./analysis_files/Fig_1D_Volcanoplot.RData")
...
#### Figure 1D ####
# Plot the volcano plot comparing the stroma clusters
p3 <- ggplot(data = r_test, aes(x = -Estimate, y = -log10(`Pr(>|t|)`), color = result_category, 
  ...
  scale_color_manual(name = "Significance", values = c("#2D69A9", "grey", "#DC0018"), 
